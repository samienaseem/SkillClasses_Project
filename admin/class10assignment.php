          ...
          <div class="container">
            <div class="myprofile">
              <form method="POST">
                ...
                <button type="button" class="btn btn-success btn-flat" onclick="uploadFile2('10')"><i class="fa fa-check-square-o" style="padding-right: 10px"></i>Upload Assignment</button>
              </form>
