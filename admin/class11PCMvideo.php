          ...
          <div class="container">
            <div class="myprofile">
              <form method="POST">
                  ...
                  <div class="form-group row">
                      <label for="name" class="col-md-4 col-form-label text-md-right">Upload Video</label>
                      <div class="col-md-6">
                        <input type="file" class="form-control" name="file1" id="file1">
                      </div>
                  </div>
                </div>
                <button type="button" class="btn btn-success btn-flat" onclick="uploadFile2('11')"><i class="fa fa-check-square-o"></i>Upload Video</button>
              </form>
